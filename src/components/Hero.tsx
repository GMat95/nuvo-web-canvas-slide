...
const Hero = () => {
  ...
  return (
    <section 
      id="home" 
      className="pt-32 pb-16 md:pt-40 md:pb-20 bg-gradient-to-br from-white to-nuvo-light overflow-hidden"
    >
      <div className="container mx-auto px-4 md:px-8">
        <div className="flex flex-col md:flex-row items-center justify-between">
          <div className="md:w-1/2 mb-12 md:mb-0">
            <h1 
              className="text-4xl md:text-5xl lg:text-6xl font-bold text-nuvo-dark leading-tight mb-6 opacity-0 animate-[fade-in_0.8s_ease-out_0.2s_forwards] transform translate-y-8"
            >
              Transforming <span className="text-nuvo-purple">Local Businesses</span> With Modern Tech Solutions
            </h1>
            <p 
              className="text-nuvo-gray text-lg md:text-xl mb-8 max-w-xl opacity-0 animate-[fade-in_0.8s_ease-out_0.6s_forwards] transform translate-y-8"
            >
            ...
            >
              ...
              <Button 
                asChild
                variant="outline" 
                className="border-nuvo-purple text-nuvo-purple hover:bg-nuvo-purple/5 px-8 py-6 text-base transition-all duration-300 hover:shadow-lg"
                size="lg"
              >
                <a href="#services">
                  Our Services
          ...
          >
            <div className="relative">
              <div className="absolute -top-6 -left-6 w-24 h-24 bg-nuvo-purple/10 rounded-full animate-pulse"></div>
              <div className="absolute -bottom-6 -right-6 w-32 h-32 bg-nuvo-blue/10 rounded-full animate-pulse" style={{ animationDelay: "1s" }}></div>
              <img 
